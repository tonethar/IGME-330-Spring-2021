...
- Structure your ES6 module code as we did in the HW - **loader.js**, **main.js**, **classes.js**, **utils.js** etc - modifying the structure as needed so that it fits with your project
...
### IV-E. Version Control (optional)
- You may want to have your project code posted to a GitHub repository - especially if you have a partner
